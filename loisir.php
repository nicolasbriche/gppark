...
<main>
    ...
    <section class="numbers">
        ...
        <div class="numbers--icon numbers--third-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                ...
                <circle class="shadow" cx="390.92" cy="375.31" r="68.31" fill="none" stroke="var(--blue)"
                    stroke-width="20px" />
                <line class="shadow" x1="106.41" y1="375.31" x2="163.88" y2="290.55" fill="none" stroke="var(--blue)"
                    stroke-width="20px" stroke-linecap="round" />
                <line class="shadow" x1="106.41" y1="375.31" x2="163.88" y2="290.55" fill="none" stroke="var(--blue)"
                    stroke-width="20px" stroke-linecap="round" />
                <line class="shadow" x1="390.92" y1="375.31" x2="340.39" y2="290.55" fill="none" stroke="var(--blue)"
                    stroke-width="20px" stroke-linecap="round" />
                <path class="shadow"
        ...
        <div class="numbers--icon numbers--fourth-icon">
            <svg id="Age" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                ...
                <line class="shadow" x1="358.62" y1="178.31" x2="358.62" y2="272.07" fill="none" stroke="var(--blue)"
                    stroke-width="20px" stroke-linecap="round" />
                <line class="shadow" x1="311.74" y1="225.19" x2="405.5" y2="225.19" fill="none" stroke="var(--blue)"
                    stroke-width="20px" stroke-linecap="round" />
                <ellipse class="shadow" cx="237.41" cy="345.87" rx="44.06" ry="48.37" fill="none" stroke="var(--blue)"
                    stroke-width="20px" />
    ...
    <section class="prices" id="prices">
        ...
        <div class="prices--cards-row">
            <div class="prices--card">
                ...
                <p class="legend-text prices--card--stuff">Possibilité de louer les équipements de sécurité sur place *
                </p>
            </div>
            <div class="prices--card">
            ...
            <div class="prices--card">
                ...
                <p class="legend-text prices--card--events-explanation">Nous organisons des évènements tout au long de
                    l’année, n’hésitez pas à nous suivre sur les réseaux pour être au courant avant tous le monde ou à
    ...
    <section class="schedule" id="schedule">
        ...
        <p class="section-tagline">
            Chez nous, les heures de pointe ne sont jamais un problème.<br>Vous pourrez toujours rouler à fond la caisse
