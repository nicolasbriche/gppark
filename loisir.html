...
<body>
    ...
    <header>
        <a href="index.php" class="header--logo">
            <img src="img/logo-gp-park-loisir.png" alt="GP Park loisir" class="header--logo">
        </a>
        ...
        <nav class="header--nav" id="header--nav">
            <ul>
                ...
                <li><a class="header--nav-item" href="#schedule">Horaires</a></li>
    ...
    <main>
        <section class="banner">
            <img src="img/banner.png" alt="gp park" class="banner--image">
            <p class="section-title banner--title">GP PARK</p>
            <p class="small-title banner--tagline">Dans la peau d'un <span>pilote</span></p>
            <p class="small--title banner--cta">Venez découvrir une expérience unique dans les hauts de France !</p>
        ...
        <section class="presentation" id="presentation">
            ...
            <p class="presentation--text">
                Vous cherchez une expérience de conduite excitante et mémorable ? Venez découvrir notre circuit de
                mini-motos uniques dans les Hauts-de-France ! Notre piste homologuée FFM offre des défis passionnants
                pour les débutants comme pour les pilotes expérimentés. Vous serez aux commandes de mini-motos
                puissantes et maniables, encadré par une équipe de professionnels dévoués qui veilleront à votre
                sécurité et à votre plaisir. Que vous soyez un groupe d’amis en quête de sensations fortes ou une
                entreprise cherchant à organiser un événement de team building original, notre circuit est l’endroit
                idéal pour vous.<br>
                Venez nous rejoindre et vivez une expérience de pilotage incomparable !<br>
        ...
        <section class="numbers">
            <div class="numbers--icon numbers--first-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    <path class="shadow" fill="none" stroke-width="20px" stroke="var(--blue)"
            ...
            <div class="numbers--icon numbers--second-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    <circle class="shadow" cx="250" cy="317.63" r="143" fill="none" stroke="var(--blue)"
                        stroke-width="20px" />
                    <circle class="blur" cx="250" cy="317.63" r="143" fill="none" stroke="var(--text-color)"
                        stroke-width="10px" />
                    <line class="shadow" x1="187.4" y1="255.03" x2="312.6" y2="380.23" fill="none" stroke="var(--blue)"
                        stroke-width="20px" stroke-linecap="round" />
                    <line class="shadow" x1="312.6" y1="255.03" x2="187.4" y2="380.23" fill="none" stroke="var(--blue)"
                        stroke-width="20px" stroke-linecap="round" />
                    <line class="blur" x1="187.4" y1="255.03" x2="312.6" y2="380.23" fill="none"
                        stroke="var(--text-color)" stroke-width="10px" stroke-linecap="round" />
                    <line class="blur" x1="312.6" y1="255.03" x2="187.4" y2="380.23" fill="none"
                        stroke="var(--text-color)" stroke-width="10px" stroke-linecap="round" />
                </svg>
            ...
            <div class="numbers--icon numbers--third-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    <circle class="shadow" cx="106.41" cy="375.31" r="68.31" fill="none" stroke="var(--blue)"
                        stroke-width="20px" />
                    <circle class="shadow" cx="390.92" cy="375.31" r="68.31" fill="none" stroke="var(--blue)"
                        stroke-width="20px" />
                    <line class="shadow" x1="106.41" y1="375.31" x2="163.88" y2="290.55" fill="none"
                        stroke="var(--blue)" stroke-width="20px" stroke-linecap="round" />
                    <line class="shadow" x1="106.41" y1="375.31" x2="163.88" y2="290.55" fill="none"
                        stroke="var(--blue)" stroke-width="20px" stroke-linecap="round" />
                    <line class="shadow" x1="390.92" y1="375.31" x2="340.39" y2="290.55" fill="none"
                        stroke="var(--blue)" stroke-width="20px" stroke-linecap="round" />
                    <path class="shadow"
                        ...
                        fill="none" stroke="var(--blue)" stroke-width="20px" />
                    <path class="shadow" d="m185.59,235.33s47.8-42.01,115.33,0" fill="none" stroke="var(--blue)"
                        stroke-width="20px" />
            ...
            <div class="numbers--icon numbers--fourth-icon">
                <svg id="Age" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    <path class="shadow"
                        ...
                        fill="none" stroke="var(--blue)" stroke-width="20px" stroke-linecap="round" />
                    <line class="shadow" x1="358.62" y1="178.31" x2="358.62" y2="272.07" fill="none"
                        stroke="var(--blue)" stroke-width="20px" stroke-linecap="round" />
                    <line class="shadow" x1="311.74" y1="225.19" x2="405.5" y2="225.19" fill="none" stroke="var(--blue)"
                        stroke-width="20px" stroke-linecap="round" />
                    <ellipse class="shadow" cx="237.41" cy="345.87" rx="44.06" ry="48.37" fill="none"
                        stroke="var(--blue)" stroke-width="20px" />
                    ...
                    <line class="blur" x1="358.62" y1="178.31" x2="358.62" y2="272.07" fill="none"
                        stroke="var(--text-color)" stroke-width="10px" stroke-linecap="round" />
                    <line class="blur" x1="311.74" y1="225.19" x2="405.5" y2="225.19" fill="none"
                        stroke="var(--text-color)" stroke-width="10px" stroke-linecap="round" />
        ...
        <section class="prices" id="prices">
            ...
            <div class="prices--cards-row">
                <div class="prices--card">
                    <p class="small-title prices--card--title">Session libre</p>
                    <p class="legend-text prices--card--bike-location">Avec location de la moto</p>
                    <div class="prices--card--price">
                        <p class="small-text">min</p>
                        <p>15</p>
                        <p class="small-text"> / sessions</p>
                    </div>
                    ...
                    <p class="legend-text prices--card--stuff">Possibilité de louer les équipements de sécurité sur
                        place *
                    </p>
                </div>
                <div class="prices--card">
                    <p class="small-title prices--card--title">Course GP1</p>
                    <p class="legend-text prices--card--bike-location">Avec location de la moto</p>
                    <div class="prices--card--price">
                        <p class="small-text">€</p>
                        <p>50</p>
                        <p class="small-text"> / personnes</p>
                    </div>
                    <p class=" small-title prices--card--driving-licence">Permis moto non obligatoire</p>
                    <button class="prices--card--button">Réserver</button>
                    <table class="prices--card--table">
                ...
                <div class="prices--card">
                    <p class="small-title prices--card--title">Course GP2</p>
                    <p class="legend-text prices--card--bike-location">Avec location de la moto</p>
                    <div class="prices--card--price">
                        <p class="small-text">€</p>
                        <p>65</p>
                ...
                <div class="prices--card">
                    <p class="small-title prices--card--title">Évènements</p>
                    <p class="legend-text prices--card--events-explanation">Nous organisons des évènements tout au long
                        de
                        l’année, n’hésitez pas à nous suivre sur les réseaux pour être au courant avant tous le monde ou
                        à
                        nous contacter pour des demandes spécifiques.</p>
                    <p class=" small-title prices--card--driving-licence">Permis moto non obligatoire</p>
                    <button class="prices--card--button">Réserver</button>
                    <table class="prices--card--table">
                        <tr>
                    ...
                    <p class="legend-text prices--card--table-caption">
        ...
        <section class="schedule" id="schedule">
            ...
            <p class="section-tagline">
                Chez nous, les heures de pointe ne sont jamais un problème.<br>Vous pourrez toujours rouler à fond la
                caisse
                sans vous soucier du trafic !
            </p>
        ...
        <section class="contact" id="contact">
            ...
            <div class="contact--details">
                ...
                <p class="contact--details--text">Pour tous renseignements supplémentaire ou pour prendre rendez-vous:
                </p>
                ...
                <ul>
                    <li><a href="#">
                            <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
                                <path class="shadow" stroke="var(--blue)" stroke-linecap="round" stroke-width="18"
                    ...
                    <li><a href="#">
                            <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
                                <path class="shadow" stroke="var(--blue)" stroke-width="18"
                                ...
                                <path class="blur" stroke="var(--text-color)" stroke-width="10"
                                    d="M96 162c-14.152 0-24.336-.007-32.276-.777-7.849-.761-12.87-2.223-16.877-4.741a36 36 0 0 1-11.33-11.329c-2.517-4.007-3.98-9.028-4.74-16.877C30.007 120.336 30 110.152 30 96c0-14.152.007-24.336.777-32.276.76-7.849 2.223-12.87 4.74-16.877a36 36 0 0 1 11.33-11.33c4.007-2.517 9.028-3.98 16.877-4.74C71.663 30.007 81.847 30 96 30c14.152 0 24.336.007 32.276.777 7.849.76 12.87 2.223 16.877 4.74a36 36 0 0 1 11.329 11.33c2.518 4.007 3.98 9.028 4.741 16.877.77 7.94.777 18.124.777 32.276 0 14.152-.007 24.336-.777 32.276-.761 7.849-2.223 12.87-4.741 16.877a36 36 0 0 1-11.329 11.329c-4.007 2.518-9.028 3.98-16.877 4.741-7.94.77-18.124.777-32.276.777Z" />
                                <circle class="blur" cx="96" cy="96" r="30" stroke="var(--text-color)"
                                    stroke-width="10" />
                    ...
                    <li><a href="#">
                            <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
                                <path class="shadow" stroke="var(--blue)" stroke-linejoin="round" stroke-width="18"
