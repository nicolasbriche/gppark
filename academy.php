    ...
    <main class="main--academy">
        ...
        <section class="presentation" id="presentation">
            ...
            <p class="presentation--text">
                GP Park Academy vous offre la possibilité de réaliser votre rêve de devenir pilote. Nous proposons des
                cours
                de pilotage pour tous les niveaux, que vous soyez débutant ou pilote expérimenté cherchant à améliorer
                vos
                compétences. Notre équipe de formateurs professionnels et expérimentés vous accompagne tout au long de
                votre
            ...
            <div class="numbers--icon numbers--second-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    ...
                    <circle class="blur" cx="250" cy="317.63" r="143" fill="none" stroke="var(--text-color)"
                        stroke-width="10px" />
                    <line class="shadow" x1="187.4" y1="255.03" x2="312.6" y2="380.23" fill="none"
                        stroke="var(--yellow)" stroke-width="20px" stroke-linecap="round" />
                    <line class="shadow" x1="312.6" y1="255.03" x2="187.4" y2="380.23" fill="none"
                        stroke="var(--yellow)" stroke-width="20px" stroke-linecap="round" />
            ...
            <div class="numbers--icon numbers--fourth-icon">
                <svg id="Age" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    ...
                    <line class="shadow" x1="358.62" y1="178.31" x2="358.62" y2="272.07" fill="none"
                        stroke="var(--yellow)" stroke-width="20px" stroke-linecap="round" />
                    <line class="shadow" x1="311.74" y1="225.19" x2="405.5" y2="225.19" fill="none"
                        stroke="var(--yellow)" stroke-width="20px" stroke-linecap="round" />
                    <ellipse class="shadow" cx="237.41" cy="345.87" rx="44.06" ry="48.37" fill="none"
                        stroke="var(--yellow)" stroke-width="20px" />
                ...
                <ul>
                    ...
                    <li><a href="#">
                            <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
                                ...
                                <circle class="shadow" cx="96" cy="96" r="30" stroke="var(--yellow)"
                                    stroke-width="18" />
